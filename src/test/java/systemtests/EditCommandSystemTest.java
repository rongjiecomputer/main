...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
        ...
        /* Case: filtered person list, edit index within bounds of planner book and person list -> edited */
        ...
        /* Case: filtered person list, edit index within bounds of planner book but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        ...
        /* Case: edit a person with new values same as another person's values but with different planner -> rejected */
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
